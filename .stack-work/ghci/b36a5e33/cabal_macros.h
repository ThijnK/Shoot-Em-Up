...
/* package shoot-em-up-0.1.0.0 */
#ifndef VERSION_shoot_em_up
#define VERSION_shoot_em_up "0.1.0.0"
#endif /* VERSION_shoot_em_up */
#ifndef MIN_VERSION_shoot_em_up
#define MIN_VERSION_shoot_em_up(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "shoot-em-up-0.1.0.0-4CWnk7L5G1g1oFPHmai5T-shoot-em-up"
