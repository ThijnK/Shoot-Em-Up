...
defaultMeteor pos speed = Meteor pos 0 speed 100 (12, 12)

defaultExplosion :: Point -> Explosion
defaultExplosion pos = Explosion pos 0 (Animation 0 10 0.075 0) (-50)

defaultTurret :: Point -> Float -> Turret
defaultTurret pos = Turret pos 0 75 (-40) (FireRate 1.5 0) (8, 10) (Animation 0 4 0.2 0)

defaultDrone :: Point -> Drone
defaultDrone pos = Drone pos 0 100 (-50) (FireRate 1 0) (8, 10) (Animation 0 4 0.2 0)
...
defaultEnemyBullet pos orient = EnemyBullet pos orient 10 500 (10,2)
